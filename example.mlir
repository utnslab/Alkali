loc("example.ep2":43:26): error: error: unknown variable 'data_addr'
loc("example.ep2":43:9): error: error: unknown variable 'desc_addr'
loc("example.ep2":44:26): error: error: unknown variable 'size'
loc("example.ep2":44:9): error: error: unknown variable 'desc_size'
loc("example.ep2":47:56): error: error: unknown variable 'data_addr'
loc("example.ep2":51:25): error: error: unknown variable 'desc_addr'
loc("example.ep2":51:9): error: error: unknown variable 'desc_addr'
module {
  ...
  ep2.func private @__handler_DMA_READ_REQ(%arg0: !ep2.atom, %arg1: !ep2.context, %arg2: i64, %arg3: i32) -> !ep2.struct<"DMA_READ_CMPL" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, !ep2.buf> attributes {event = "DMA_READ_REQ", type = "handler"} {
    %0 = "ep2.init"() : () -> !ep2.buf
  ...
  ep2.func private @__handler_DMA_READ_CMPL_receive_desc(%arg0: !ep2.context, %arg1: !ep2.buf) -> !ep2.struct<"DMA_READ_REQ" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, i64, i32> attributes {atom = "receive_desc", event = "DMA_READ_CMPL", type = "handler"} {
    ...
    %2 = ep2.struct_access %1[0] : <"Desc_Hdr" : isEvent = false, elementTypes = i64, i32> -> i64
    %3 = "ep2.context_ref"(%arg0) <{name = "desc_addr"}> : (!ep2.context) -> !ep2.conref<i64>
    "ep2.store"(%3, %2) : (!ep2.conref<i64>, i64) -> ()
    %4 = "ep2.nop"() : () -> none
    %5 = ep2.struct_access %1[1] : <"Desc_Hdr" : isEvent = false, elementTypes = i64, i32> -> i32
    %6 = "ep2.context_ref"(%arg0) <{name = "desc_size"}> : (!ep2.context) -> !ep2.conref<i32>
    "ep2.store"(%6, %5) : (!ep2.conref<i32>, i32) -> ()
    %7 = "ep2.nop"() : () -> none
