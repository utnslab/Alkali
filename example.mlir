module {
  ...
  ep2.func private @__handler_DMA_READ_REQ(%arg0: !ep2.atom, %arg1: !ep2.context, %arg2: i64, %arg3: i32) -> !ep2.struct<"DMA_READ_CMPL" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, !ep2.buf> attributes {event = "DMA_READ_REQ", extern = true, type = "handler"} {
    %0 = "ep2.init"() : () -> !ep2.buf
  ...
  ep2.func private @__handler_DMA_READ_REQ_receive_payload_1(%arg0: !ep2.context, %arg1: i64, %arg2: i32) attributes {atom = "receive_payload_1", event = "DMA_READ_REQ", type = "handler"} {
    %0 = "ep2.init"() : () -> i64
    %1 = "ep2.context_ref"(%arg0) <{name = "desc_addr"}> : (!ep2.context) -> !ep2.conref<!ep2.any>
    %2 = "ep2.load"(%1) : (!ep2.conref<!ep2.any>) -> i64
    %3 = "ep2.context_ref"(%arg0) <{name = "desc_addr"}> : (!ep2.context) -> !ep2.conref<!ep2.any>
    %4 = "ep2.add"(%2, %arg1) : (i64, i64) -> i64
    "ep2.store"(%3, %4) : (!ep2.conref<!ep2.any>, i64) -> ()
    %5 = "ep2.nop"() : () -> none
    ep2.return
  }
}