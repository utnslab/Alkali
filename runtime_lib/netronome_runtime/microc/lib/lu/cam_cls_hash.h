...
#ifndef _LU__CAM_HASH_CLS_H_
#define _LU__CAM_HASH_CLS_H_
 ...
 */
__intrinsic int32_t camht_cls_lookup(__cls void *hash_tbl, __cls void *key_tbl,
 ...
 */
__intrinsic int32_t camht_cls_lookup_idx(__cls void *hash_tbl, int32_t entries,
 ...
 * be returned.
 */
__intrinsic int32_t camht_cls_lookup_idx_add(__cls void *hash_tbl,
                                         int32_t entries,
                                         struct camht_hash_t* hash,
                                         int32_t* added);
 ...
 */
__intrinsic int32_t camht_cls_lookup_add(__cls void *hash_tbl,
                                    __cls void *key_tbl,
                                    int32_t entries,
                                    void *key, size_t key_sz,
                                    size_t entry_sz,
                                    int32_t* added);
#endif /* _LU__CAM_HASH_CLS_H_ */
