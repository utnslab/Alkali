...
__intrinsic int32_t
camht_cls_lookup(__cls void *hash_tbl,__cls void *key_tbl,
...
__intrinsic int32_t
camht_cls_lookup_idx(__cls void *hash_tbl, int32_t entries,
                struct camht_hash_t* hash)
{
...
__intrinsic int32_t
camht_cls_lookup_idx_add(__cls void *hash_tbl,
                    int32_t entries,
                    struct camht_hash_t* hash,
                    int32_t* added)
{
...
__intrinsic int32_t
camht_cls_lookup_add(__cls void *hash_tbl, __cls void *key_tbl,
                    int32_t entries,
