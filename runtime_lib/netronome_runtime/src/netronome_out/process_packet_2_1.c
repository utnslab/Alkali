...
static struct tcp_tracker_t _loc_buf_19;
__xrw static struct tcp_tracker_t _loc_buf_19_xfer;
static int rr_ctr = 0;
...
void __event___handler_NET_RECV_2_process_packet_2_1() {
  ...
  v2 = &work;
  v3 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_NET_RECV_2_1, v3, sizeof(*v3));
  *(v2) = *(v3);
  v4 = v2->ctx;
  v5 = v2->f0;
  v6 = v4->f8;
