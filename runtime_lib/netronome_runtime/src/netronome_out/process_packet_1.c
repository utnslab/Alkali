...
static struct firewall_tcpport_entries_t _loc_buf_3;
__xrw static struct firewall_tcpport_entries_t _loc_buf_3_xfer;
static struct eth_header_t _loc_buf_0;
__xrw static struct eth_header_t _loc_buf_0_xfer;
static struct priority_entries_t _loc_buf_4;
__xrw static struct priority_entries_t _loc_buf_4_xfer;
static int rr_ctr = 0;
