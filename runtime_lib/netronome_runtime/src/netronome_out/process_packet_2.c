...
static struct priority_entries_t _loc_buf_9;
__xrw static struct priority_entries_t _loc_buf_9_xfer;
static struct eth_header_t _loc_buf_5;
__xrw static struct eth_header_t _loc_buf_5_xfer;
static struct tcp_header_t _loc_buf_7;
__xrw static struct tcp_header_t _loc_buf_7_xfer;
static struct ip_header_t _loc_buf_6;
__xrw static struct ip_header_t _loc_buf_6_xfer;
static struct firewall_tcpport_entries_t _loc_buf_8;
__xrw static struct firewall_tcpport_entries_t _loc_buf_8_xfer;
static int rr_ctr = 0;
