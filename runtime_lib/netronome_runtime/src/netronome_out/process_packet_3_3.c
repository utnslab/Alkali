...
static struct err_tracker_t _loc_buf_36;
__xrw static struct err_tracker_t _loc_buf_36_xfer;
static struct tcp_tracker_t _loc_buf_35;
__xrw static struct tcp_tracker_t _loc_buf_35_xfer;
static int rr_ctr = 0;
...
__forceinline
void __event___handler_NET_RECV_3_process_packet_3_3() {
  uint32_t v1;
  uint32_t v2;
  uint32_t v3;
  ...
  v4 = &work;
  v5 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_NET_RECV_3_3, v5, sizeof(*v5));
  *(v4) = *(v5);
  v6 = v4->ctx;
  v7 = v4->f0;
  v8 = v6->f4;
...
int main(void) {
	init_me_cam(16);
	init_recv_event_workq(WORKQ_ID_NET_RECV_3_3, workq_NET_RECV_3_3, WORKQ_TYPE_NET_RECV_3, WORKQ_SIZE_NET_RECV_3, 8);
	wait_global_start_();
	for (;;) {
		__event___handler_NET_RECV_3_process_packet_3_3();
	}
}
