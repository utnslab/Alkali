...
static struct tcp_tracker_t _loc_buf_23;
__xrw static struct tcp_tracker_t _loc_buf_23_xfer;
static int rr_ctr = 0;
...
__forceinline
void __event___handler_NET_RECV_2_process_packet_2_3() {
  uint32_t v1;
  ...
  v2 = &work;
  v3 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_NET_RECV_2_3, v3, sizeof(*v3));
  *(v2) = *(v3);
  v4 = v2->ctx;
  v5 = v2->f0;
  v6 = v4->f8;
...
int main(void) {
	init_me_cam(16);
	init_recv_event_workq(WORKQ_ID_NET_RECV_2_3, workq_NET_RECV_2_3, WORKQ_TYPE_NET_RECV_2, WORKQ_SIZE_NET_RECV_2, 8);
	wait_global_start_();
	for (;;) {
		__event___handler_NET_RECV_2_process_packet_2_3();
	}
}
