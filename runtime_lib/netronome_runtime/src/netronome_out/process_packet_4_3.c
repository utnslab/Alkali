...
static struct lb_DIP_entries_t _loc_buf_87;
__xrw static struct lb_DIP_entries_t _loc_buf_87_xfer;
static struct lb_fwd_tcp_hdr_t _loc_buf_80;
__xrw static struct lb_fwd_tcp_hdr_t _loc_buf_80_xfer;
static struct firewall_meta_header_t _loc_buf_78;
__xrw static struct firewall_meta_header_t _loc_buf_78_xfer;
static struct connect_tracker_meta_header_t _loc_buf_79;
__xrw static struct connect_tracker_meta_header_t _loc_buf_79_xfer;
static int rr_ctr = 0;
...
__forceinline
void __event___handler_NET_RECV_4_process_packet_4_3() {
  uint32_t v1;
  uint32_t v2;
  uint32_t v3;
  uint32_t v4;
  ...
  v6 = &work;
  v7 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_NET_RECV_4_3, v7, sizeof(*v7));
  *(v6) = *(v7);
  v8 = v6->ctx;
  v9 = v6->f0;
  v10 = v6->f1;
  ...
  v19->f0 = v14;
  v19->f3 = v13;
  v26 = &_loc_buf_78_xfer;
  *(v26) = *(v19);
  mem_write32(&v26->f0, v11.buf + v11.offs, 28);
  v11.offs += 28;
  v20->f0 = v10;
  v20->f1 = v12;
  v29 = &_loc_buf_79_xfer;
  *(v29) = *(v20);
...
int main(void) {
	init_me_cam(16);
	init_recv_event_workq(WORKQ_ID_NET_RECV_4_3, workq_NET_RECV_4_3, WORKQ_TYPE_NET_RECV_4, WORKQ_SIZE_NET_RECV_4, 8);
	wait_global_start_();
	for (;;) {
		__event___handler_NET_RECV_4_process_packet_4_3();
	}
}
