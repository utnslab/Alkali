module {
  ...
  ep2.func private @__handler_NET_RECV_process_packet(%arg0: !ep2.context, %arg1: !ep2.buf) attributes {atom = "process_packet", event = "NET_RECV", instances = ["cu2", "cu3"], location = "cu2", type = "handler"} {
    %1 = "ep2.init"() : () -> !ep2.struct<"flow_state_t" : isEvent = false, elementTypes = i32, i16, i16, i32, i32, i32, i32, i32, i32, i16, i16, i32, i32, i8, i8, i16, i16, i16, i16, i16, i32, i32, i32>
    ...
    %4 = "ep2.lookup"(%3, %2) : (!ep2.table<i16, !ep2.struct<"flow_state_t" : isEvent = false, elementTypes = i32, i16, i16, i32, i32, i32, i32, i32, i32, i16, i16, i32, i32, i8, i8, i16, i16, i16, i16, i16, i32, i32, i32>, 16>, i64) -> !ep2.struct<"flow_state_t" : isEvent = false, elementTypes = i32, i16, i16, i32, i32, i32, i32, i32, i32, i16, i16, i32, i32, i8, i8, i16, i16, i16, i16, i16, i32, i32, i32>
    ...
    %5 = "ep2.nop"() : () -> none
    %6 = "ep2.constant"() <{value = "net_send"}> : () -> !ep2.atom
    %7 = "ep2.init"(%6, %arg0, %arg1) : (!ep2.atom, !ep2.context, !ep2.buf) -> !ep2.struct<"NET_SEND" : isEvent = true, elementTypes = !ep2.context, !ep2.buf>
