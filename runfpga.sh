...
./build/bin/ep2c-opt  --ep2-context-infer --ep2-context-to-argument -ep2-buffer-to-value -canonicalize -cse -canonicalize -ep2-linearize  -ep2-emit-fpga tmp.mlir -o tmpopt.mlir
