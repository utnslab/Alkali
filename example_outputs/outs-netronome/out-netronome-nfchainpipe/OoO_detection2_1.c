...
static struct lb_fwd_tcp_hdr_t _loc_buf_49;
__xrw static struct lb_fwd_tcp_hdr_t _loc_buf_49_xfer;
static struct lb_DIP_entries_t _loc_buf_48;
__xrw static struct lb_DIP_entries_t _loc_buf_48_xfer;
static int rr_ctr = 0;
...
__forceinline
void __event___handler_OoO_DETECT2_OoO_detection2_1() {
  uint32_t v1;
  uint32_t v2;
  uint16_t v3;
  uint16_t v4;
  ...
  v7 = &work;
  v8 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_OoO_DETECT2_1, v8, sizeof(*v8));
  *(v7) = *(v8);
  v9 = v7->ctx;
  v10 = v7->f0;
  v11 = v7->f1;
...
int main(void) {
	init_me_cam(16);
	init_recv_event_workq(WORKQ_ID_OoO_DETECT2_1, workq_OoO_DETECT2_1, WORKQ_TYPE_OoO_DETECT2, WORKQ_SIZE_OoO_DETECT2, 8);
	wait_global_start_();
	for (;;) {
		__event___handler_OoO_DETECT2_OoO_detection2_1();
	}
}
