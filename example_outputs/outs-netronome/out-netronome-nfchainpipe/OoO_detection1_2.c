...
static struct ip_tracker_t _loc_buf_38;
__xrw static struct ip_tracker_t _loc_buf_38_xfer;
static struct tcp_tracker_t _loc_buf_37;
__xrw static struct tcp_tracker_t _loc_buf_37_xfer;
static struct err_tracker_t _loc_buf_39;
__xrw static struct err_tracker_t _loc_buf_39_xfer;
static struct flow_tracker_t _loc_buf_36;
__xrw static struct flow_tracker_t _loc_buf_36_xfer;
static int rr_ctr = 0;
...
__forceinline
void __event___handler_OoO_DETECT1_OoO_detection1_2() {
  uint32_t v1;
  uint32_t v2;
  ...
  v3 = &work;
  v4 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_OoO_DETECT1_2, v4, sizeof(*v4));
  *(v3) = *(v4);
  v5 = v3->ctx;
  v6 = v3->f0;
  v7 = v3->f1;
  ...
  *(v32) = *(v31);
  cls_workq_add_work(WORKQ_ID_OoO_DETECT2_2, v32, sizeof(*v32));
  return;
}
...
int main(void) {
	init_me_cam(16);
	init_recv_event_workq(WORKQ_ID_OoO_DETECT1_2, workq_OoO_DETECT1_2, WORKQ_TYPE_OoO_DETECT1, WORKQ_SIZE_OoO_DETECT1, 8);
	wait_global_start_();
	for (;;) {
		__event___handler_OoO_DETECT1_OoO_detection1_2();
	}
}
