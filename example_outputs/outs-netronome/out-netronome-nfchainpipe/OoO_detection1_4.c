...
static struct err_tracker_t _loc_buf_47;
__xrw static struct err_tracker_t _loc_buf_47_xfer;
static struct flow_tracker_t _loc_buf_44;
__xrw static struct flow_tracker_t _loc_buf_44_xfer;
static struct ip_tracker_t _loc_buf_46;
__xrw static struct ip_tracker_t _loc_buf_46_xfer;
static struct tcp_tracker_t _loc_buf_45;
__xrw static struct tcp_tracker_t _loc_buf_45_xfer;
static int rr_ctr = 0;
...
__forceinline
void __event___handler_OoO_DETECT1_OoO_detection1_4() {
  uint32_t v1;
  uint32_t v2;
  ...
  v3 = &work;
  v4 = &work_ref;
  cls_workq_add_thread(WORKQ_ID_OoO_DETECT1_4, v4, sizeof(*v4));
  *(v3) = *(v4);
  v5 = v3->ctx;
  v6 = v3->f0;
  v7 = v3->f1;
  ...
  *(v32) = *(v31);
  cls_workq_add_work(WORKQ_ID_OoO_DETECT2_4, v32, sizeof(*v32));
  return;
}
...
int main(void) {
	init_me_cam(16);
	init_recv_event_workq(WORKQ_ID_OoO_DETECT1_4, workq_OoO_DETECT1_4, WORKQ_TYPE_OoO_DETECT1, WORKQ_SIZE_OoO_DETECT1, 8);
	wait_global_start_();
	for (;;) {
		__event___handler_OoO_DETECT1_OoO_detection1_4();
	}
}
