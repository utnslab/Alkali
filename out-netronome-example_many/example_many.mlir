module {
  ...
  ep2.func private @__handler_DMA_RECV_CMPL_receive_desc(%arg0: !ep2.context, %arg1: !ep2.buf) attributes {atom = "receive_desc", event = "DMA_RECV_CMPL", type = "handler"} {
    ...
    %13 = "ep2.nop"() : () -> none
    %14 = ep2.struct_access %1[2] : <"recv_desc_t" : isEvent = false, elementTypes = i32, i32, i32, i32> -> i32
    %15 = "ep2.constant"() <{value = 1 : i64}> : () -> i64
    %16 = "ep2.cmp"(%14, %15) <{predicate = 40 : i16}> : (i32, i64) -> i1
    scf.if %16 {
      %17 = "ep2.constant"() <{value = "process_desc"}> : () -> !ep2.atom
      %18 = "ep2.constant"() <{value = 100 : i64}> : () -> i64
      %19 = "ep2.init"(%17, %arg0, %18) : (!ep2.atom, !ep2.context, i64) -> !ep2.struct<"USER_EVENT1" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, i32>
      ep2.return %19 : !ep2.struct<"USER_EVENT1" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, i32>
    } else {
      %17 = "ep2.constant"() <{value = "process_desc2"}> : () -> !ep2.atom
      %18 = "ep2.constant"() <{value = 100 : i64}> : () -> i64
      %19 = "ep2.init"(%17, %arg0, %18) : (!ep2.atom, !ep2.context, i64) -> !ep2.struct<"USER_EVENT2" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, i32>
      ep2.return %19 : !ep2.struct<"USER_EVENT2" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, i32>
    }
    "ep2.terminate"() : () -> ()
  }
