...
static struct firewall_tcpport_entries_t _loc_buf_12;
__xrw static struct firewall_tcpport_entries_t _loc_buf_12_xfer;
static struct firewall_ip_entries_t _loc_buf_11;
__xrw static struct firewall_ip_entries_t _loc_buf_11_xfer;
static struct tcp_header_t _loc_buf_10;
__xrw static struct tcp_header_t _loc_buf_10_xfer;
static struct firewall_meta_header_t _loc_buf_15;
__xrw static struct firewall_meta_header_t _loc_buf_15_xfer;
static struct ip_header_t _loc_buf_9;
__xrw static struct ip_header_t _loc_buf_9_xfer;
...
static struct priority_entries_t _loc_buf_13;
__xrw static struct priority_entries_t _loc_buf_13_xfer;
static int rr_ctr = 0;
...
void __event___handler_NET_RECV_process_packet_2() {
  ...
  *(v39) = *(v38);
  cls_workq_add_work(WORKQ_ID_OoO_DETECT1_2, v39, sizeof(*v39));
  return;
}
