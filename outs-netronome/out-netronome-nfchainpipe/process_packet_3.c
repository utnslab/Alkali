...
__xrw static struct eth_header_t _loc_buf_16_xfer;
static struct ip_header_t _loc_buf_17;
...
__xrw static struct priority_entries_t _loc_buf_21_xfer;
static int rr_ctr = 0;
...
void __event___handler_NET_RECV_process_packet_3() {
  ...
  *(v39) = *(v38);
  cls_workq_add_work(WORKQ_ID_OoO_DETECT1_3, v39, sizeof(*v39));
  return;
}
