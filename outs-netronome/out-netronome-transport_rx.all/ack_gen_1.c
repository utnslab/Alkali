...
static struct eth_header_t_sub_0 _loc_buf_14;
__xrw static struct eth_header_t_sub_0 _loc_buf_14_xfer;
static struct repack_type_1 _loc_buf_17;
__xrw static struct repack_type_1 _loc_buf_17_xfer;
static struct ip_header_t_sub_1 _loc_buf_16;
__xrw static struct ip_header_t_sub_1 _loc_buf_16_xfer;
static int rr_ctr = 0;
...
void __event___handler_ACK_GEN_ack_gen_1() {
  ...
  __shared __cls struct tcp_header_t_sub_0* v10;
  struct tcp_header_t_sub_0* v11;
  __xrw struct tcp_header_t_sub_0* v12;
  struct __buf_t v13;
  __shared __cls struct ip_header_t_sub_1* v14;
  struct ip_header_t_sub_1* v15;
  __xrw struct ip_header_t_sub_1* v16;
  uint32_t v17;
  uint16_t v18;
  uint32_t v19;
  ...
  *(v15) = *(v16);
  ...
  v35 = v6->f1;
  v11->f3 = v35;
  v37 = &_loc_buf_14_xfer;
  *(v37) = *(v8);
  v13.offs = 0;
  mem_write32(&v37->f0, v13.buf + v13.offs, 12);
  v38 = &_loc_buf_17;
  v38->f0 = v2;
  v39 = &_loc_buf_17_xfer;
  *(v39) = *(v38);
  v13.offs = 16;
  mem_write8(&v39->f0, v13.buf + v13.offs, 2);
  v40 = &_loc_buf_16_xfer;
  *(v40) = *(v15);
  v13.offs = 26;
  mem_write32(&v40->f0, v13.buf + v13.offs, 8);
  v41 = &_loc_buf_15_xfer;
  *(v41) = *(v11);
  v13.offs = 38;
  mem_write32(&v41->f0, v13.buf + v13.offs, 12);
