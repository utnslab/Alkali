...
static struct pkt_info_t _loc_buf_32;
__xrw static struct pkt_info_t _loc_buf_32_xfer;
static struct ip_header_t _loc_buf_7;
__xrw static struct ip_header_t _loc_buf_7_xfer;
static struct eth_header_t _loc_buf_6;
__xrw static struct eth_header_t _loc_buf_6_xfer;
static struct tcp_header_t _loc_buf_8;
__xrw static struct tcp_header_t _loc_buf_8_xfer;
...
void __event___handler_NET_RECV_process_packet_3() {
  ...
  *(v12) = *(v13);
  v14 = &v5->f0;
  v15 = &_loc_buf_24;
  v16 = &_loc_buf_24_xfer;
  *(v16) = *(v15);
  cls_write(&v16->f0, &v14->f0, 12);
  v14->f2 = v16->f2;
  v17 = &v5->f1;
  v18 = &_loc_buf_25;
  v19 = &_loc_buf_25_xfer;
  *(v19) = *(v18);
  cls_write(&v19->f0, &v17->f0, 24);
  v20 = &v5->f2;
  v21 = &_loc_buf_26;
  v22 = &_loc_buf_26_xfer;
  *(v22) = *(v21);
