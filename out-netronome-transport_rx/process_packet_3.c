...
static struct repack_type_0 _loc_buf_12;
__xrw static struct repack_type_0 _loc_buf_12_xfer;
static struct eth_header_t_sub_0 _loc_buf_11;
__xrw static struct eth_header_t_sub_0 _loc_buf_11_xfer;
static struct ip_header_t_sub_1 _loc_buf_13;
__xrw static struct ip_header_t_sub_1 _loc_buf_13_xfer;
static struct tcp_header_t_sub_0 _loc_buf_14;
__xrw static struct tcp_header_t_sub_0 _loc_buf_14_xfer;
static struct pkt_info_t _loc_buf_10;
__xrw static struct pkt_info_t _loc_buf_10_xfer;
static int rr_ctr = 0;
...
void __event___handler_NET_RECV_process_packet_3() {
  ...
  struct eth_header_t_sub_0* _loc_buf_11;
  __xrw struct eth_header_t_sub_0* v8;
  struct repack_type_0* _loc_buf_12;
  __xrw struct repack_type_0* v9;
  uint16_t v10;
  struct ip_header_t_sub_1* _loc_buf_13;
  __xrw struct ip_header_t_sub_1* v11;
  struct tcp_header_t_sub_0* _loc_buf_14;
  ...
  v10 = _loc_buf_12.f0;
  ;
  v11 = &_loc_buf_13_xfer;
  v6.offs = 26;
  mem_read32(&v11->f0, v6.buf + v6.offs, 8);
  _loc_buf_13 = *(v11);
  ;
  v12 = &_loc_buf_14_xfer;
  v6.offs = 38;
  ...
  v21 = &v5->f1;
  ;
  v22 = &_loc_buf_13_xfer;
  *(v22) = _loc_buf_13;
  cls_write(&v22->f0, &v21->f0, 8);
  v23 = &v5->f2;
  ;
  v24 = &_loc_buf_11_xfer;
  *(v24) = _loc_buf_11;
  cls_write(&v24->f0, &v23->f0, 12);
  v25 = &v5->f3;
  ;
  v26 = &_loc_buf_14_xfer;
  *(v26) = _loc_buf_14;
