...
struct pkt_info_t _loc_buf_20;
__xrw struct pkt_info_t _loc_buf_20_xfer;
struct ip_header_t _loc_buf_7;
__xrw struct ip_header_t _loc_buf_7_xfer;
struct tcp_header_t _loc_buf_8;
__xrw struct tcp_header_t _loc_buf_8_xfer;
struct eth_header_t _loc_buf_6;
__xrw struct eth_header_t _loc_buf_6_xfer;
