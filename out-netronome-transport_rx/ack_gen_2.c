...
static struct tcp_header_t_sub_0 _loc_buf_31;
__xrw static struct tcp_header_t_sub_0 _loc_buf_31_xfer;
static struct eth_header_t_sub_0 _loc_buf_30;
__xrw static struct eth_header_t_sub_0 _loc_buf_30_xfer;
static int rr_ctr = 0;
...
void __event___handler_ACK_GEN_ack_gen_2() {
  ...
  __shared __cls struct eth_header_t_sub_0* v7;
  struct eth_header_t_sub_0* _loc_buf_30;
  __xrw struct eth_header_t_sub_0* v8;
  __shared __cls struct tcp_header_t_sub_0* v9;
  struct tcp_header_t_sub_0* _loc_buf_31;
  __xrw struct tcp_header_t_sub_0* v10;
  __shared __cls struct ip_header_t_sub_1* v11;
  ...
  *(v3) = *(v4);
  ...
  v11 = &v5->f1;
  ;
  v12 = &_loc_buf_32_xfer;
  cls_read(&v12->f0, &v11->f0, 8);
  _loc_buf_32 = *(v12);
  v13 = v5->f0;
  v14 = _loc_buf_30.f0;
  v15 = _loc_buf_30.f1;
  ...
  v28 = v6->f1;
  _loc_buf_31.f3 = v28;
  v30 = &_loc_buf_30_xfer;
  *(v30) = _loc_buf_30;
  v13.offs = 0;
  mem_write32(&v30->f0, v13.buf + v13.offs, 12);
  ;
  _loc_buf_33.f0 = v2;
  v31 = &_loc_buf_33_xfer;
  *(v31) = _loc_buf_33;
  v13.offs = 16;
  mem_write8(&v31->f0, v13.buf + v13.offs, 2);
  v32 = &_loc_buf_32_xfer;
  *(v32) = _loc_buf_32;
  v13.offs = 26;
  mem_write32(&v32->f0, v13.buf + v13.offs, 8);
  v33 = &_loc_buf_31_xfer;
  *(v33) = _loc_buf_31;
  v13.offs = 38;
  mem_write32(&v33->f0, v13.buf + v13.offs, 12);
