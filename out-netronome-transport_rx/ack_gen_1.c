...
static struct ip_header_t _loc_buf_13;
__xrw static struct ip_header_t _loc_buf_13_xfer;
static struct tcp_header_t _loc_buf_14;
__xrw static struct tcp_header_t _loc_buf_14_xfer;
static struct eth_header_t _loc_buf_12;
__xrw static struct eth_header_t _loc_buf_12_xfer;
...
void __event___handler_ACK_GEN_ack_gen_1() {
  ...
  *(v31) = *(v9);
  mem_write32(&v31->f0, &v7->f0, 12);
  v7.offs += 12;
  mem_write8(&v31->f2, &v7->f2, 2);
  v7.offs += 2;
  v32 = &_loc_buf_13_xfer;
  *(v32) = *(v15);
  mem_write32(&v32->f0, &v7->f0, 24);
  v7.offs += 24;
  v33 = &_loc_buf_14_xfer;
  *(v33) = *(v22);
  mem_write32(&v33->f0, &v7->f0, 20);
  v7.offs += 20;
  v34 = v5->f0;
  bulk_memcpy(v7.buf + v7.offs, &v34->f0, v34.sz - v34.offs);
