module {
  ...
  ep2.func private @__handler_DMA_RECV_CMPL_receive_desc(%arg0: !ep2.context, %arg1: !ep2.buf) attributes {atom = "receive_desc", event = "DMA_RECV_CMPL", type = "handler"} {
    ...
    %3 = "ep2.context_ref"(%arg0) <{name = "flow_id"}> : (!ep2.context) -> !ep2.conref<i32>
    %4 = ep2.struct_access %2[0] : <"recv_desc_t" : isEvent = false, elementTypes = i32, i32, i32, i32> -> i32
    "ep2.store"(%3, %4) : (!ep2.conref<i32>, i32) -> ()
    %5 = "ep2.context_ref"(%arg0) <{name = "bump_seq"}> : (!ep2.context) -> !ep2.conref<i32>
    %6 = ep2.struct_access %2[1] : <"recv_desc_t" : isEvent = false, elementTypes = i32, i32, i32, i32> -> i32
    "ep2.store"(%5, %6) : (!ep2.conref<i32>, i32) -> ()
    %7 = "ep2.context_ref"(%arg0) <{name = "flags"}> : (!ep2.context) -> !ep2.conref<i32>
    %8 = ep2.struct_access %2[2] : <"recv_desc_t" : isEvent = false, elementTypes = i32, i32, i32, i32> -> i32
    "ep2.store"(%7, %8) : (!ep2.conref<i32>, i32) -> ()
    %9 = "ep2.context_ref"(%arg0) <{name = "flow_grp"}> : (!ep2.context) -> !ep2.conref<i32>
    %10 = ep2.struct_access %2[3] : <"recv_desc_t" : isEvent = false, elementTypes = i32, i32, i32, i32> -> i32
    "ep2.store"(%9, %10) : (!ep2.conref<i32>, i32) -> ()
    %11 = "ep2.init"(%1, %arg0, %0) : (!ep2.atom, !ep2.context, i64) -> !ep2.struct<"USER_EVENT1" : isEvent = true, elementTypes = !ep2.atom, !ep2.context, i32>
